...
// Функция для тестирования сортировок с разным количеством элементов
void testSorts(int n) {
    QuickSort<int> quickSorter;
    BubbleSorter<int> bubbleSorter;
    InsertionSort<int> insertionSort;
    HeapSort<int> heapSorter; // Добавляем тестирование пирамидальной сортировки
...
// Функция для сравнения производительности сортировок
void comparing() {
...
// Функция для проверки корректности сортировок
void checking() {
    QuickSort<int> quickSorter;
    BubbleSorter<int> bubbleSorter;
    InsertionSort<int> insertionSort;
